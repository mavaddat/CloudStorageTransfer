...
setup(
    ...
    url='https://github.com/mavaddat/CloudStorageTransfer',  # Optional
    ...
    keywords='cloud storage aws transfer',  # Optional
    ...
    install_requires=[
        'boto3', 'dropbox', 'mega.py', 'onedrivesdk',
        'google-cloud-storage', 'pyicloud', 'boxsdk'
    ],  # Optional
    ...
    entry_points={  # Optional
        'console_scripts': [
            'cloudtransfer=cloudtransfer:main',
        ],
    },
